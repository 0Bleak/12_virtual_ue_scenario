...
prb={}
SLICE_NAME={3:"CRITICAL",1:"PERFORMANCE",2:"BUSINESS"}
# evaluation throughput target (DL) per slice for violation graphs
SLA_DL_TARGET={3:350_000,1:300_000,2:20_000_000}
...
def on_open(ws): ws.send(json.dumps({"cmd":"metrics_subscribe"})); print("[LOG v4] sub 8002 (12 UEs)")
def on_msg(ws,msg):
    try:
        d=json.loads(msg)
