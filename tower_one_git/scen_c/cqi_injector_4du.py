...
DU_STREAMS = [
    {"url":"127.0.0.1:8003","e2_node":"gnbd_001_001_00000213_1","slice_order":[3,1,2]},
    {"url":"127.0.0.1:8004","e2_node":"gnbd_001_001_00000213_2","slice_order":[3,1,2]},
    {"url":"127.0.0.1:8005","e2_node":"gnbd_001_001_00000213_3","slice_order":[3,1,2]},
    {"url":"127.0.0.1:8006","e2_node":"gnbd_001_001_00000213_4","slice_order":[3,1,3]},
]
    ...
    def __init__(self, path):
        ...
        with open(path) as f:
            ...
            for row in csv.DictReader(f):
                ...
                if last is None or ts[:19]!=last[:19]: self.v.append(c); last=ts
...
def main():
    ...
    def du_loop(stream):
        ...
        while True:
            try:
                ws=websocket.create_connection(f"ws://{url}",timeout=5)
    ...
    for s in DU_STREAMS: threading.Thread(target=du_loop,args=(s,),daemon=True).start()
    threading.Thread(target=merge,daemon=True).start()
    print("[INJ] 4 DUs (8003-8006) -> 8002")
